...
- Uses quantized Mistral 7B Instruct v0.1 GGUF models.
  ...
  - This chatbot uses Mistral GGUF models and the [`huggingface/candle`](https://github.com/huggingface/candle) framework, whereas the original uses GGML models and the `rustformers/llm` crate.
